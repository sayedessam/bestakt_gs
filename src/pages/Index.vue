  ...
  <v-container >
	...
	<!-- 	style="position: relative; top: 7px; display: block; margin-left: auto;
		...
		<v-row align="center" justify="center" dense>
			...
			<v-col cols="12" sm="3" class="center" dense>
				<g-image alt="Saudi Arabia | السعودية" 
      		src="~/Saudi.png" width="30" />
				<g-image alt="United Arab Emirates | الإمارات العربية" 
      		src="~/UAE.png" width="30" />
				<g-image alt="Bahrain | البحرين" 
      		src="~/Bahrain.png" width="30" />
				<g-image alt="Kuwait | الكويت" 
      		src="~/Kuwait.png" width="30" />
				<g-image alt="Qatar | قطر" 
      		src="~/Qatar.png" width="30" />
				<g-image alt="egypt | مصر" 
      		src="~/Egypt.png" width="30" />
	
			</v-col>
			<v-col cols="12" sm="3" class="center teal--text" dense>
				<h3>
				الإستعانة بمصادر خارجية عن بعد
				</h3>
			</v-col>
		</v-row>
...
<v-container fluid justify="center">
    ...
    >
      ...
      height="200px"
      :src="require('~/coder.png')"
      >
        <v-card-title class="white--text font-weight-bold txt-bkg">
          الاستعانة بمصادر خارجية عن بعد
        </v-card-title>
      </v-img>

      <v-card-subtitle class="pb-0 font-weight-bold">
      وفر المال والجهد والوقت
      </v-card-subtitle>

      <v-card-text class="text--primary">
        <div class="font-weight-bold">
        الشركات  الناجحة تستعين بمصادر خارجية للقيام بإدارة العاملين والمحاسبة والضرائب والمشتريات  وإدارة تقنية المعلومات حتى توفر المال والوقت لنمو الإيرادات والأرباح. 
        
        </div>

        <div>
        خبراء بست تاكت فى خدمتك - اتصل الآن
        </div>
      </v-card-text>
    </v-card>
    <br />
...
<v-card
    ...
    >
      ...
      class="white--text align-end"
      height="200px"
      :src="require('~/crisis-min.png')"
   
      >
        <v-card-title class="white--text font-weight-bold txt-bkg">
          إدارة الأزمات ، مثل جائحة كورونا
        </v-card-title>
      </v-img>

      <v-card-subtitle class="pb-0 font-weight-bold">
      تخفيف مخاطر الازمات يضمن الاستمرارية
      </v-card-subtitle>

      <v-card-text class="text--primary">
        <div class="font-weight-bold">
          مستشارون بست تاكت يتمتعون بخبرات متراكمة فى منطقة الخليج وشمال إفريقيا لمساعدتك بإدارة الأزمات وتقليص المخاطر على أعمالك من آثار الأزمات مثل جائحة كورونا (كوفيد-19).
        </div>
...
<br />
  <v-card
    ...
    >
      ...
      <v-card-subtitle class="pb-0 font-weight-bold">
        ترشيد المصروفات سبيل المنافسة
      </v-card-subtitle>

      <v-card-text class="text--primary">
        <div class="font-weight-bold">
          نساعدك لتحويل المصروفات الثابتة إلى مصروفات متغيرة ، تزيد وتنقص حسب مقدار الأعمال وإيرادات الشركة.
 خبراء بست تاكت يقدمون لك حلول عملية لترشيد المصروفات.
...
<style>
	...
	.txt-bkg {
		background-color: rgba(86, 61, 124,.55)
	}
