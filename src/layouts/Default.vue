  ...
  >
      ...
      >
        <v-list dense>
          <v-list-item link>
            <v-list-item-action>
              <v-icon color="#14cba8">mdi-home</v-icon>
            </v-list-item-action>
            <v-list-item-content>
              <v-list-item-title>
              <g-link
          ...
          <v-list-item link>
            <v-list-item-action>
              <v-icon color="#14cba8">mdi-information</v-icon>
            </v-list-item-action>
            <v-list-item-content>
              <v-list-item-title>
               <g-link 
          ...
          <v-list-item link>
            <v-list-item-action>
              <v-icon color="#14cba8">mdi-email</v-icon>
            </v-list-item-action>
            <v-list-item-content>
              <v-list-item-title>
               <g-link 
          ...
          <v-list-item link>
            <v-list-item-action>
              <v-icon color="#14cba8">mdi-account-multiple</v-icon>
            </v-list-item-action>
            <v-list-item-content>
              <v-list-item-title>
               <g-link 
          ...
          <v-list-item link>
            <v-list-item-action>
              <v-icon color="#14cba8">mdi-credit-card</v-icon>
            </v-list-item-action>
            <v-list-item-content>
              <v-list-item-title>
               <g-link 
          ...
          <v-list-item link>
            <v-list-item-action>
              <v-icon color="#14cba8">mdi-cash-register</v-icon>
            </v-list-item-action>
            <v-list-item-content>
              <v-list-item-title>
               <g-link 
          ...
          <v-list-item link>
            <v-list-item-action>
              <v-icon color="#14cba8">mdi-cash-multiple</v-icon>
            </v-list-item-action>
            <v-list-item-content>
              <v-list-item-title>
               <g-link 
          ...
          <v-list-item link>
            <v-list-item-action>
              <v-icon color="#14cba8">mdi-signal-cellular-2</v-icon>
            </v-list-item-action>
            <v-list-item-content>
              <v-list-item-title>
               <g-link 
          ...
          <v-list-item link>
            <v-list-item-action>
              <v-icon color="#14cba8">mdi-bullseye-arrow</v-icon>
            </v-list-item-action>
            <v-list-item-content>
              <v-list-item-title>
               <g-link 
    ...
    <slot/>
      ...
      flat
      tile
      class="text-center primary mx-auto"
